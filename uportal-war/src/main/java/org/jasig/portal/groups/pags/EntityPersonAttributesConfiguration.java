...
public class EntityPersonAttributesConfiguration implements IPersonAttributesConfiguration {
   ...
   public Map<String, GroupDefinition> getConfig() {
      ...
      Set<PersonAttributeGroupDefinitionImpl> groups = store.getGroups();
   ...
   private GroupDefinition initGroupDef(PersonAttributeGroupDefinitionImpl group) {
      ...
      Iterator<PersonAttributeGroupTestGroupDefinitionImpl> testGroupIterator = group.getTestGroups().iterator();
      while(testGroupIterator.hasNext()) {
          PersonAttributeGroupTestGroupDefinitionImpl testGroup = testGroupIterator.next();
          TestGroup tg = new TestGroup();
          Iterator<PersonAttributeGroupTestDefinitionImpl> testsIterator = testGroup.getTests().iterator();
          while(testsIterator.hasNext()) {
              PersonAttributeGroupTestDefinitionImpl test = testsIterator.next();
   ...
   private void addMemberKeys(GroupDefinition groupDef, Set<PersonAttributeGroupDefinitionImpl> members) {
       Iterator<PersonAttributeGroupDefinitionImpl> memberIterator = members.iterator();
       while(memberIterator.hasNext()) {
           groupDef.addMember(memberIterator.next().getName());
       }
   }
