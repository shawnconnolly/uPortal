...
public class JpaPersonAttributeGroupTestGroupDefinitionDao extends BasePortalJpaDao implements IPersonAttributeGroupTestGroupDefinitionDao {
    ...
    public List<IPersonAttributeGroupTestGroupDefinition> getPersonAttributeGroupTestGroupDefinitions() {
        ...
        final List<PersonAttributeGroupTestGroupDefinitionImpl> results = query.getResultList();
        return new ArrayList<IPersonAttributeGroupTestGroupDefinition>(new LinkedHashSet<IPersonAttributeGroupTestGroupDefinition>(results));
    }
    ...
    @Override
    public IPersonAttributeGroupTestGroupDefinition getPersonAttributeGroupTestGroupDefinition(Long testId) {
        final NaturalIdQuery<PersonAttributeGroupTestGroupDefinitionImpl> query = this.createNaturalIdQuery(PersonAttributeGroupTestGroupDefinitionImpl.class);
        query.using(PersonAttributeGroupTestGroupDefinitionImpl_.internalPersonAttributeGroupTestGroupDefinitionId, testId);
        return query.load();
    }
